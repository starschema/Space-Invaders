...
var gamePlay = [
    {
        LEVEL: 1,
        INTERVAL_LINE: 335,
        INTERVAL_FIRE_MONSTER_MIN: 1000,
        INTERVAL_FIRE_MONSTER_MAX: 1700,
        INTERVAL_FIRE_MONSTER_STEP: 100,
        SPEED_BIG_MONSTER: 1.5
    },
    {
        LEVEL: 2,
        INTERVAL_LINE: 275,
        INTERVAL_FIRE_MONSTER_MIN: 800,
        INTERVAL_FIRE_MONSTER_MAX: 1400,
        INTERVAL_FIRE_MONSTER_STEP: 100,
        SPEED_BIG_MONSTER: 2
    },
    {
        LEVEL: 3,
        INTERVAL_LINE: 250,
        INTERVAL_FIRE_MONSTER_MIN: 650,
        INTERVAL_FIRE_MONSTER_MAX: 1050,
        INTERVAL_FIRE_MONSTER_STEP: 50,
        SPEED_BIG_MONSTER: 2.5
    },
    {
        LEVEL: 4,
        INTERVAL_LINE: 210,
        INTERVAL_FIRE_MONSTER_MIN: 500,
        INTERVAL_FIRE_MONSTER_MAX: 800,
        INTERVAL_FIRE_MONSTER_STEP: 35,
        SPEED_BIG_MONSTER: 3
    },
    {
        LEVEL: 5,
        INTERVAL_LINE: 180,
        INTERVAL_FIRE_MONSTER_MIN: 375,
        INTERVAL_FIRE_MONSTER_MAX: 550,
        INTERVAL_FIRE_MONSTER_STEP: 30,
        SPEED_BIG_MONSTER: 3.5
    },
    {
        LEVEL: 6,
        INTERVAL_LINE: 150,
        INTERVAL_FIRE_MONSTER_MIN: 260,
        INTERVAL_FIRE_MONSTER_MAX: 420,
        INTERVAL_FIRE_MONSTER_STEP: 30,
        SPEED_BIG_MONSTER: 4
    },
    {
        LEVEL: 7,
        INTERVAL_LINE: 120,
        INTERVAL_FIRE_MONSTER_MIN: 200,
        INTERVAL_FIRE_MONSTER_MAX: 375,
        INTERVAL_FIRE_MONSTER_STEP: 30,
        SPEED_BIG_MONSTER: 4
    },
    {
        LEVEL: 8,
        INTERVAL_LINE: 100,
        INTERVAL_FIRE_MONSTER_MIN: 170,
        INTERVAL_FIRE_MONSTER_MAX: 340,
        INTERVAL_FIRE_MONSTER_STEP: 30,
        SPEED_BIG_MONSTER: 4.5
    },
    {
        LEVEL: 9,
        INTERVAL_LINE: 80,
        INTERVAL_FIRE_MONSTER_MIN: 125,
        INTERVAL_FIRE_MONSTER_MAX: 300,
        INTERVAL_FIRE_MONSTER_STEP: 30,
        SPEED_BIG_MONSTER: 5.5
    },
    {
        LEVEL: 10,
        INTERVAL_LINE: 65,
        INTERVAL_FIRE_MONSTER_MIN: 80,
        INTERVAL_FIRE_MONSTER_MAX: 200,
        INTERVAL_FIRE_MONSTER_STEP: 20,
        SPEED_BIG_MONSTER: 6
    }
]
...
function fire() {
    ...
    Highscore.eventHappened("fire", game.SCORE);
...
function checkCollisionP() {
    ...
    for (var i = 0; i < game.monsters.length; i++) {
        ...
        var items = quadBulletS.retrieve({
            x: monster.localToGlobal().x,
            y: monster.localToGlobal().y,
            height: monster.texture.height,
            width: monster.texture.width
        });
            ...
            for (var j = 0; j < items.length; j++) {
                ...
                if (colliding) {
                    ...
                    if (monster.type === "boss") {
                        Highscore.eventHappened("big-monster", game.SCORE);
                    } else {
                        Highscore.eventHappened("normal-monster", game.SCORE);
                    }
...
function checkCollisionS() {
    var items = quadBulletP.retrieve({
        ...
        height: spaceship.texture.height,
        width: spaceship.texture.width
    });
    ...
    if (items.length > 0) {
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            if (colliding) {
                ...
                Highscore.eventHappened("die", game.SCORE);
                game.LIFE--;
                updateLife();
...
function checkCollisionBP() {
    ...
    for (var i = 0; i < game.bridges.length; i++) {
        ...
        var itemP = quadBulletP.retrieve({
            x: bridgeS.localToGlobal().x,
            y: bridgeS.localToGlobal().y,
            height: bridgeS.texture.height,
            width: bridgeS.texture.width
        });
...
function nextLevel() {
    ...
    Highscore.eventHappened("levelup", game.SCORE);
